...
function display_tips() {
    ...
    let tip= "> Each row should have numbers 1-9, no repeats.";
    let tip2 ="> Each column should have numbers 1-9, no repeats.";
    let tip3 = ">Each 3x3 quadrant should have numbers 1-9, no repeats."
    qs(".toast-body").textContent = tip+tip2+tip3;
